<script>
    ...
    let result = $state('75675.33302684457');
    ...
    const Examples = [{
      expression: '(20000(P|A, 15%, 2) + 25000(P|A, 0.15, 3)(P|F, 15%, 2))',
      result: '75675.33302684457',
    ...
    async function handleCalculate() {
        ...
        try {
            ...
            if (response.failed) {
                errorMessage = "Failed to calculate the expression. Please make sure it's written correctly.";
          ...
          <div class="bg-white p-4 rounded shadow-sm">
            ...
            >
              {#if showCopiedFeedback}
                <div class="position-absolute top-0 start-50 translate-middle-x mt-1 bg-dark text-white px-2 py-1 rounded" style="font-size: 0.75rem; z-index: 10; white-space: nowrap;">
                  Copied!
                </div>
              {/if}
              <div class="d-flex align-items-center">
                <span class="me-2" style="font-family: 'Roboto Mono', monospace; font-size: 1.2rem;"></span>
                <div class="w-100 position-relative">
                  <div class="result-value" style="
            ...
            <div class="d-flex justify-content-between align-items-center">
              <div class="text-muted small" style="font-family: 'Inter', sans-serif;">
  ...
  <div class="modal fade" id="expressionsModal" tabindex="-1" aria-labelledby="expressionsModalLabel" aria-hidden="true">
